 ...
 */
final class Version20200312205442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actor (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(75) NOT NULL, lastname VARCHAR(75) NOT NULL, UNIQUE INDEX UNIQ_447556F983A00E683124B5B6 (firstname, lastname), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
